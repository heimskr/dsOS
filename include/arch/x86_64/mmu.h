#ifndef ARCH_X86_64_MMU_H_
#define ARCH_X86_64_MMU_H_

#define BOOT_PHYSICAL_VIRTUAL_OFFSET              (KERNEL_VIRTUAL_START - KERNEL_PHYSICAL_START)
#define KERNEL_VIRTUAL_START_PAGE_DIRECTORY_ENTRY (KERNEL_VIRTUAL_START / LEVEL_TWO_PAGE_SIZE)
